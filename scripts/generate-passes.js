...
const footer = `<footer>
<div><a href="/">Pass Checker</a> shows live conditions for 134 mountain passes across 30 US states and 2 Canadian provinces. Washington and British Columbia are free forever.</div>
...
function indexPage(regions) {
  const title = `Mountain Pass Conditions — 134 Passes, Live Status`;
  const desc = `Live open/closed status for 134 mountain passes across 30 US states and 2 Canadian provinces. From Snoqualmie to the Coquihalla to Newfound Gap.`;
...
<p class="sub">134 passes &middot; 30 states &middot; 2 provinces</p>
<a class="cta" href="${APP_STORE}">Get Pass Checker on the App Store</a>
${groups}
${footer}`;
}
